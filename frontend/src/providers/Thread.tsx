...
export function ThreadProvider({ children }: { children: ReactNode }) {
  ...
  const [apiUrl] = useQueryState("apiUrl", {
    defaultValue: envApiUrl || "/api",
  });
  const [assistantId] = useQueryState("assistantId", {
    // Keep thread search working even when NEXT_PUBLIC_ASSISTANT_ID isn't
    // inlined at build time (common in Docker runtime env setups).
